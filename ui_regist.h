...
"border-color: rgb(255, 255, 255);"));
        ...
        frame->setGeometry(QRect(279, 116, 367, 461));
        frame->setStyleSheet(QString::fromUtf8("background-image: url(:/new/prefix1/picture/\346\263\250\345\206\214.png);"));
        frame->setFrameShape(QFrame::StyledPanel);
        frame->setFrameShadow(QFrame::Raised);
        exit_but = new QPushButton(regist);
        exit_but->setObjectName(QStringLiteral("exit_but"));
        exit_but->setGeometry(QRect(549, 538, 81, 21));
