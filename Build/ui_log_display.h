...
public:
    ...
    void setupUi(QMainWindow *log_display)
    {
        ...
        log_display->resize(1279, 649);
        centralwidget = new QWidget(log_display);
        centralwidget->setObjectName(QStringLiteral("centralwidget"));
        layoutWidget = new QWidget(centralwidget);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(600, 40, 221, 501));
        ...
        log_text->setGeometry(QRect(80, 40, 511, 501));
        label = new QLabel(centralwidget);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(50, 21, 791, 541));
        label->setStyleSheet(QString::fromUtf8("border-image: url(:/new/prefix1/picture/\346\241\206Big.png);"));
        label_2 = new QLabel(centralwidget);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(-250, 370, 621, 371));
        label_2->setStyleSheet(QStringLiteral("border-image: url(:/new/prefix1/picture/22334.png);"));
