...
public:
    ...
    void setupUi(QMainWindow *user_information)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(600, 220, 246, 431));
        ...
        gridLayout_2->addLayout(horizontalLayout_5, 15, 0, 1, 2);
        ...
        gridLayout_2->addWidget(phone_edit, 10, 1, 1, 1);
        ...
        gridLayout_2->addLayout(horizontalLayout_4, 14, 0, 1, 2);
        ...
        gridLayout_2->addWidget(level_edit, 11, 1, 1, 1);
        ...
        gridLayout_2->addWidget(name_edit, 8, 1, 1, 1);
        ...
        gridLayout_2->addWidget(email_edit, 9, 1, 1, 1);

        user_id_but = new QRadioButton(gridLayoutWidget);
        user_id_but->setObjectName(QStringLiteral("user_id_but"));

        gridLayout_2->addWidget(user_id_but, 1, 0, 1, 1);

        user_name_but = new QRadioButton(gridLayoutWidget);
        user_name_but->setObjectName(QStringLiteral("user_name_but"));

        gridLayout_2->addWidget(user_name_but, 1, 1, 1, 1);
        ...
        user_table->setGeometry(QRect(70, 220, 521, 431));
        label_3 = new QLabel(centralwidget);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(50, 140, 821, 541));
        label_3->setStyleSheet(QString::fromUtf8("border-image: url(:/new/prefix1/picture/\346\241\206Big.png);"));
        label_12 = new QLabel(centralwidget);
        label_12->setObjectName(QStringLiteral("label_12"));
        label_12->setGeometry(QRect(380, 160, 161, 51));
        label_12->setStyleSheet(QString::fromUtf8("font: 75 28pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        label_10 = new QLabel(centralwidget);
        label_10->setObjectName(QStringLiteral("label_10"));
        label_10->setGeometry(QRect(640, 40, 301, 181));
        label_10->setStyleSheet(QStringLiteral("border-image: url(:/new/prefix1/picture/22332.png);"));
    ...
    void retranslateUi(QMainWindow *user_information)
    {
        ...
        search_but->setText(QApplication::translate("user_information", "\346\220\234\347\264\242", 0));
        label_2->setText(QApplication::translate("user_information", "\345\257\206\347\240\201", 0));
        ...
        user_id_but->setText(QApplication::translate("user_information", "\345\270\220\345\217\267", 0));
        user_name_but->setText(QApplication::translate("user_information", "\347\224\250\346\210\267\345\220\215", 0));
