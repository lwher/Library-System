...
public:
    ...
    QLabel *label_9;
    QPushButton *borrow_but;
    QTableWidget *book_table;
    QLabel *label_11;
    QLabel *book_admin_label;
    QLabel *label_13;
    QLabel *book_user_label;
    QLabel *root_name_edit;
    ...
    void setupUi(QMainWindow *book_information)
    {
        ...
        gridLayoutWidget_2->setGeometry(QRect(950, 190, 252, 521));
        ...
        logout = new QPushButton(gridLayoutWidget_2);
        ...
        borrow_but = new QPushButton(gridLayoutWidget_2);
        borrow_but->setObjectName(QStringLiteral("borrow_but"));

        gridLayout_2->addWidget(borrow_but, 18, 1, 1, 1);
        ...
        book_table->setGeometry(QRect(110, 190, 831, 521));
        ...
        label_11->setGeometry(QRect(100, 100, 1121, 631));
        label_11->setStyleSheet(QString::fromUtf8("border-image: url(:/new/prefix1/picture/\346\241\206Big.png);"));
        book_admin_label = new QLabel(centralwidget);
        book_admin_label->setObjectName(QStringLiteral("book_admin_label"));
        book_admin_label->setGeometry(QRect(540, 120, 161, 51));
        book_admin_label->setStyleSheet(QString::fromUtf8("font: 75 28pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        label_13 = new QLabel(centralwidget);
        label_13->setObjectName(QStringLiteral("label_13"));
        label_13->setGeometry(QRect(90, 50, 351, 141));
        label_13->setStyleSheet(QStringLiteral("border-image: url(:/new/prefix1/picture/22337.png);"));
        book_user_label = new QLabel(centralwidget);
        book_user_label->setObjectName(QStringLiteral("book_user_label"));
        book_user_label->setGeometry(QRect(540, 120, 161, 51));
        book_user_label->setStyleSheet(QString::fromUtf8("font: 75 28pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        root_name_edit = new QLabel(centralwidget);
        root_name_edit->setObjectName(QStringLiteral("root_name_edit"));
        root_name_edit->setGeometry(QRect(1010, 140, 121, 20));
        root_name_edit->setStyleSheet(QString::fromUtf8("font: 75 11pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        book_information->setCentralWidget(centralwidget);
        label_11->raise();
        gridLayoutWidget_2->raise();
        book_table->raise();
        book_admin_label->raise();
        label_13->raise();
        book_user_label->raise();
        root_name_edit->raise();
    ...
    void retranslateUi(QMainWindow *book_information)
    {
        ...
        logout->setText(QApplication::translate("book_information", "\346\263\250\351\224\200", 0));
        ...
        label_9->setText(QApplication::translate("book_information", "ISBN", 0));
        borrow_but->setText(QApplication::translate("book_information", "\346\210\221\347\232\204\345\200\237\351\230\205", 0));
        ...
        book_admin_label->setText(QApplication::translate("book_information", "\344\271\246\347\261\215\347\256\241\347\220\206", 0));
        label_13->setText(QString());
        book_user_label->setText(QApplication::translate("book_information", "\344\271\246\347\261\215\346\237\245\350\257\242", 0));
        root_name_edit->setText(QApplication::translate("book_information", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\"><br/></span></p></body></html>", 0));
    } // retranslateUi
