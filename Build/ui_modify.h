...
public:
    ...
    void setupUi(QDialog *modify)
    {
        ...
        modify->resize(835, 584);
        frame = new QFrame(modify);
        frame->setObjectName(QStringLiteral("frame"));
        frame->setEnabled(true);
        frame->setGeometry(QRect(260, 80, 367, 461));
        frame->setStyleSheet(QString::fromUtf8("background-image: url(:/new/prefix1/picture/\344\277\256\346\224\271\347\224\250\346\210\267\344\277\241\346\201\257.png);"));
        frame->setFrameShape(QFrame::StyledPanel);
        frame->setFrameShadow(QFrame::Raised);
        exit_but = new QPushButton(modify);
        exit_but->setObjectName(QStringLiteral("exit_but"));
        exit_but->setGeometry(QRect(529, 504, 81, 21));
