...
public:
    ...
    void setupUi(QDialog *modify)
    {
        ...
        frame_2->setGeometry(QRect(0, 0, 361, 731));
        frame_2->setStyleSheet(QString::fromUtf8("border-image: url(:/new/prefix1/picture/\346\241\2062.png);"));
...
"border-color: rgb(255, 255, 255);"));
        ...
        label_8->setGeometry(QRect(220, 420, 121, 131));
        label_8->setStyleSheet(QStringLiteral("border-image: url(:/new/prefix1/picture/22.png);"));
        frame->raise();
        label->raise();
        label_5->raise();
        label_4->raise();
    ...
    void retranslateUi(QDialog *modify)
    {
        ...
        label_6->setText(QApplication::translate("modify", "<html><head/><body><p align=\"right\"><span style=\" font-weight:600;\">\351\202\200\350\257\267\347\240\201</span></p></body></html>", 0));
