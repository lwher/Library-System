...
public:
    ...
    void setupUi(QWidget *Doge)
    {
        ...
        doge_warning_label->setGeometry(QRect(50, 10, 141, 141));
        ...
        pushButton->setGeometry(QRect(160, 180, 61, 23));
        ...
        doge_success_label->setGeometry(QRect(50, 10, 141, 141));
    ...
    void retranslateUi(QWidget *Doge)
    {
        ...
        pushButton->setText(QApplication::translate("Doge", "\345\225\245!", 0));
        doge_edit->setText(QApplication::translate("Doge", "<html><head/><body><p align=\"center\"><br/></p></body></html>", 0));
