...
public:
    ...
    void setupUi(QMainWindow *event_information)
    {
        ...
        gridLayout->addWidget(exit_but, 16, 1, 1, 1);
        ...
        gridLayout->addWidget(user_info_but, 13, 0, 1, 1);
        ...
        gridLayout->addWidget(log_but, 12, 0, 1, 1);
        ...
        logout_but = new QPushButton(layoutWidget);
        logout_but->setObjectName(QStringLiteral("logout_but"));

        gridLayout->addWidget(logout_but, 16, 0, 1, 1);

        borrow_but = new QPushButton(layoutWidget);
        borrow_but->setObjectName(QStringLiteral("borrow_but"));

        gridLayout->addWidget(borrow_but, 11, 1, 1, 1);
    ...
    void retranslateUi(QMainWindow *event_information)
    {
        ...
        logout_but->setText(QApplication::translate("event_information", "\346\263\250\351\224\200", 0));
        borrow_but->setText(QApplication::translate("event_information", "\346\210\221\347\232\204\345\200\237\351\230\205", 0));
        ...
        root_name_edit->setText(QApplication::translate("event_information", "<html><head/><body><p align=\"center\"><br/></p></body></html>", 0));
    } // retranslateUi
