...
public:
    ...
    void setupUi(QMainWindow *event_information)
    {
        ...
        event_information->resize(993, 646);
        centralwidget = new QWidget(event_information);
        centralwidget->setObjectName(QStringLiteral("centralwidget"));
        layoutWidget = new QWidget(centralwidget);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(770, 60, 191, 501));
        ...
        gridLayout->addWidget(insert_but, 6, 0, 1, 2);
        ...
        gridLayout->addWidget(return_but, 8, 0, 1, 2);

        event_table = new QTableWidget(centralwidget);
        if (event_table->columnCount() < 7)
            event_table->setColumnCount(7);
        QFont font;
        ...
        event_table->setHorizontalHeaderItem(6, __qtablewidgetitem6);
        event_table->setObjectName(QStringLiteral("event_table"));
        event_table->setGeometry(QRect(20, 60, 741, 501));
    ...
    void retranslateUi(QMainWindow *event_information)
    {
        ...
        label_5->setText(QApplication::translate("event_information", "\347\274\226\345\217\267", 0));
        ...
        ___qtablewidgetitem->setText(QApplication::translate("event_information", "\347\274\226\345\217\267", 0));
        QTableWidgetItem *___qtablewidgetitem1 = event_table->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("event_information", "\345\270\220\345\217\267", 0));
        QTableWidgetItem *___qtablewidgetitem2 = event_table->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("event_information", "\347\224\250\346\210\267\345\220\215", 0));
        QTableWidgetItem *___qtablewidgetitem3 = event_table->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("event_information", "\344\271\246\345\217\267", 0));
        QTableWidgetItem *___qtablewidgetitem4 = event_table->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("event_information", "\344\271\246\345\220\215", 0));
        QTableWidgetItem *___qtablewidgetitem5 = event_table->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("event_information", "\345\200\237\351\230\205\346\227\266\351\227\264", 0));
        QTableWidgetItem *___qtablewidgetitem6 = event_table->horizontalHeaderItem(6);
        ___qtablewidgetitem6->setText(QApplication::translate("event_information", "\345\275\222\350\277\230\346\227\266\351\227\264", 0));
    } // retranslateUi
